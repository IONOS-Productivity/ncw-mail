...
class IonosAccountCreationService {
	 ...
	 * @return MailAccount The created or updated mail account
	 * @throws ServiceException If account creation fails
	 */
	public function createOrUpdateAccount(string $userId, string $emailUser, string $accountName): MailAccount {
