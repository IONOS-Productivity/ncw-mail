...
class IonosCreateAccountTest extends TestCase {
	...
	public function testSuccessfulAccountCreation(): void {
		...
		$mailAccount->setEmail(self::TEST_EMAIL_USER);
		$mailAccount->setUserId(self::TEST_USER_ID);
		$mailAccount->setName(self::TEST_ACCOUNT_NAME);

		$savedAccount = new \OCA\Mail\Account($mailAccount);
