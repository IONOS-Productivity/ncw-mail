...
class IonosProviderFacadeTest extends TestCase {
	...
	public function testGetMailboxesReturnsMailboxList(): void {
		...
		$mockResponse1->method('getName')->willReturn('User One');
		...
		$mockResponse2->method('getName')->willReturn('User Two');
	...
	public function testGetMailboxesHandlesEmailWithoutName(): void {
		...
		$mockResponse->method('getName')->willReturn(null);
		...
		$this->assertEquals('user3', $result[0]['name']); // Falls back to userId
	}
}
