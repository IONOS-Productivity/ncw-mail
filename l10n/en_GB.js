OC.L10N.register(
    ...
    "Email Administration" : "Manage email",
    "Email Provider Accounts" : "Email management",
    ...
    "Mail server marked this message as phishing attempt" : "Mail server marked this message as phishing attempt",
    ...
    "Reply-To email: %1$s is different from sender email: %2$s" : "Reply-To email: %1$s is different from sender email: %2$s",
    "Mail connection performance" : "Mail connection performance",
    ...
    "Mail account parameters, aliases and preferences" : "Mail account parameters, aliases and preferences",
    ...
    "IMAP server denied authentication" : "IMAP server denied authentication",
    "SMTP server denied authentication" : "SMTP server denied authentication",
    "IMAP authentication error" : "IMAP authentication error",
    "SMTP authentication error" : "SMTP authentication error",
    "IMAP connection failed" : "IMAP connection failed",
    ...
    "Please enter an email of the format name@example.com" : "Please enter an email of the format name@example.com",
    "Password" : "Password",
    "Enable mark as important classification" : "Enable mark as important classification",
    "Manual" : "Manual",
    "IMAP Settings" : "IMAP Settings",
    "IMAP Host" : "IMAP Host",
    "IMAP Security" : "IMAP Security",
    ...
    "Create alias" : "Create alias",
    "Cancel" : "Cancel",
    "Search the body of messages in priority Inbox" : "Search the body of messages in priority Inbox",
    "Activate" : "Activate",
    "Make mails available to Context Chat" : "Make mails available to Context Chat",
    "Remind about messages that require a reply but received none" : "Remind about messages that require a reply but received none",
    "Highlight external addresses" : "Highlight external addresses",
    "Could not update preference" : "Could not update preference",
    "Mail settings" : "Mail settings",
    "General" : "General",
    "Set as default mail app" : "Set as default mail app",
    "Add mail account" : "Add mail account",
    "Appearance" : "Appearance",
    "Show all messages in thread" : "Show all messages in thread",
    "When off, only the selected message will be shown" : "When off, only the selected message will be shown",
    "Sort favorites up" : "Sort favourites up",
    "When on, favorite messages will be sorted to the top of folders" : "When enabled, favourite messages will be sorted to the top of their respective folders",
    "Layout" : "Layout",
    "Vertical split" : "Vertical split",
    "Horizontal split" : "Horizontal split",
    "List" : "List",
    "Use compact mode" : "Use compact mode",
    "Sorting" : "Sorting",
    "Newest first" : "Newest first",
    "Oldest first" : "Oldest first",
    "Avatars from Gravatar and favicons" : "Avatars from Gravatar and favicons",
    "Reply position" : "Reply position",
    "Top" : "Top",
    "Bottom" : "Bottom",
    "Text blocks" : "Text blocks",
    "Reusable pieces of text that can be inserted in messages" : "Reusable pieces of text that can be inserted in messages",
    "New text block" : "New text block",
    "Shared with me" : "Shared with me",
    "Privacy" : "Privacy",
    "Data collection" : "Data collection",
    "Allow the app to collect and process data locally to adapt to your preferences" : "Allow the app to collect and process data locally to adapt to your preferences",
    "Always show images from" : "Always show images from",
    "Security" : "Security",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Manage your internal addresses and domains to ensure recognized contacts stay unmarked",
    "S/MIME" : "S/MIME",
    ...
    "Step 2" : "Step 2",
    "Enable for the current domain" : "Enable for the current domain",
    "Assistance features" : "Assistance features",
    ...
    "Choose target folder" : "Choose target folder",
    "No more submailboxes in here" : "No more submailboxes in here",
    "Messages will automatically be marked as important using AI. The system learns from which messages you interact with or mark as important. In the beginning you might have to manually change the importance to teach it, but it will improve over time" : "Messages will automatically be marked as important using AI. The system learns from which messages you interact with or mark as important. In the beginning you might have to manually change the importance to teach it, but it will improve over time",
    "Messages that you marked as favorite will be shown at the top of folders. You can disable this behavior in the app settings" : "Messages that you marked as favorite will be shown at the top of folders. You can disable this behavior in the app settings",
    "AI identifies messages sent by you that likely require a reply but did not receive one after a couple of days and shows them here" : "AI identifies messages sent by you that likely require a reply but did not receive one after a couple of days and shows them here",
    "Favorites" : "Favourites",
    "Favorites info" : "Favorites info",
    "Load more favorites" : "Load more favorites",
    "Follow up" : "Follow up",
    "Follow up info" : "Follow up info",
    "Load more follow ups" : "Load more follow ups",
    "Important info" : "Important info",
    ...
    "Train" : "Train",
    "Mark message as" : "Mark message as",
    "Add flag" : "Add flag",
    "Move into folder" : "Move into folder",
    "Stop" : "Stop",
    "Delete action" : "Delete action",
