OC.L10N.register(
    ...
    "(organizer)" : "(arrangör)",
    "_{count} mailbox_::_{count} mailboxes_" : ["{count} brevlåda","{count} brevlådor"],
    "_{count} mailbox …_::_{count} mailboxes …_" : ["{count} brevlåda …","{count} brevlådor …"],
    "{from}\n{subject}" : "{from}\n{subject}",
    ...
    "Allow users to create mail aliases" : "Låt användarna skapa e-postalias",
    ...
    "Are you sure you want to delete the mailbox for {email}?" : "Är du säker på att du vill ta bort postlådan för {email}?",
    ...
    "Delete mailbox" : "Ta bort postlåda",
    ...
    "Display name" : "Visningsnamn",
    "Display name cannot be empty" : "Visningsnamnet får inte vara tomt",
    "domain" : "domän",
    ...
    "Email Address" : "E-postadress",
    "Email address already exists" : "E-postadressen finns redan",
    "Email Address:" : "E-postadress:",
    "Email Administration" : "Hantera e-post",
    "Email Provider Accounts" : "E-posthantering",
    "Email username" : "E-postanvändarnamn",
    "Email username cannot be empty" : "E-postanvändarnamnet får inte vara tomt",
    "Email username contains invalid characters. Use only letters, numbers, dots, hyphens, and underscores." : "E-postanvändarnamnet innehåller ogiltiga tecken. Använd endast bokstäver, siffror, punkter, bindestreck och understreck.",
    ...
    "Failed to delete mailbox" : "Det gick inte att ta bort postlådan",
    "Failed to load email providers" : "Det gick inte att ladda e-postleverantörer",
    "Failed to load mailboxes" : "Det gick inte att ladda postlådorna",
    "Failed to load providers" : "Det gick inte att ladda e-postleverantörer",
    "Failed to update mailbox" : "Det gick inte att uppdatera postlådan",
    "Favorite" : "Favorit",
    "Favorites" : "Favoriter",
    "Filters" : "Filter",
    ...
    "Layout" : "Layout",
    "Linked User" : "Länkad användare",
    "List of mailboxes. This list is not fully rendered for performance reasons. The mailboxes will be rendered as you navigate through the list." : "Lista över postlådor. Denna lista visas inte fullständigt av prestandaskäl. Postlådorna visas när du navigerar genom listan.",
    "Load more" : "Ladda mer",
    "Loading …" : "Läser in ...",
    "Loading mailboxes..." : "Laddar postlådor...",
    "Loading messages …" : "Läser in meddelanden …",
    "Loading providers..." : "Laddar e-postleverantörer...",
    "Mail" : "E-post",
    "Mail address" : "E-postadress",
    "Mail app" : "Mail-app",
    "Mail configured" : "E-post konfigurerad",
    "Mail server" : "E-postserver",
    "Mail settings" : "E-postinställningar",
    "Mailbox deleted successfully" : "Postlådan har raderats",
    "Mailbox deletion" : "Radering av postlåda",
    "Mailbox updated successfully" : "Postlådan har uppdaterats",
    "Mails" : "E-post",
    "Manage certificates" : "Hantera certifikat",
    "Manage email accounts for your users" : "Hantera e-postkonton för dina användare",
    "Manage Emails" : "Hantera e-postmeddelanden",
    "Manual" : "Manuellt",
    ...
    "No mailboxes found" : "Inga postlådor hittades",
    ...
    "Select email provider" : "Välj e-postleverantör",
    ...
    "Total rows summary" : "Sammanfattning av totala rader",
    "Train" : "Tåg",
