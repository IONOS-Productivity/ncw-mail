OC.L10N.register(
    ...
    "_{count} mailbox …_::_{count} mailboxes …_" : ["{count} boîte mail …","\n{count} boîtes mail …","{count} boîte mail …"],
    "{from}\n{subject}" : "{from}\n{subject}",
    ...
    "Allow aliases" : "Autoriser les alias",
    ...
    "Allow users to create mail aliases" : "Permettre aux utilisateurs de créer des alias de messagerie",
    ...
    "Creating aliases has been disabled by the administrator." : "L'administrateur a désactivé la création d'alias.",
    "Custom" : "Personnalisé",
    ...
    "The Mail app does not verify aliases. If this is enabled without existing server-side support, your mail server will likely reject outgoing messages, causing emails to fail." : "L'application Mail ne vérifie pas les alias. Si cette fonctionnalité est activée sans prise en charge côté serveur, votre serveur de messagerie risque de rejeter les messages sortants, ce qui entraînera l'échec de l'envoi des e-mails.",
