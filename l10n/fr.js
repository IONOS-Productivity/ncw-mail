OC.L10N.register(
    ...
    "\"Mark Not Junk\" Email Address" : "Adresse e-mail de signalement \"Marquer comme fiable\"",
    ...
    "_{count} mailbox_::_{count} mailboxes_" : ["{count} boîte mail","{count} boîtes mail","{count} boîtes mail"],
    "_{count} mailbox …_::_{count} mailboxes …_" : ["{count} boîte mail …","{count} boîtes mail …","{count} boîtes mail …"],
    "{from}\n{subject}" : "{from}\n{subject}",
    "{markup-start}Draft:{markup-end} {subject}" : "{markup-start}Brouillon : {markup-end} {subject}",
    ...
    "Account state conflict. Please try again later" : "Conflit d'état du compte. Veuillez réessayer plus tard",
    ...
    "Add internal email or domain" : "Ajouter un e-mail interne ou un domaine",
    ...
    "An error occurred, unable to rename the mailbox." : "Une erreur est survenue, impossible de renommer le dossier.",
    ...
    "Are you sure you want to delete the mailbox for {email}?" : "Êtes-vous sûr de vouloir supprimer la boîte aux lettres de {email} ?",
    ...
    "Autoresponder follows system settings" : "Le réponse automatique suit les paramètres système",
    ...
    "Back" : "Retour",
    "Back to all actions" : "Retour à toutes les actions",
    "Bcc" : "Cci",
    ...
    "Choose a text block to insert at the cursor" : "Choisissez un bloc de texte à insérer à l'emplacement du curseur",
    "Choose target folder" : "Sélectionner le dossier cible",
    "Choose the headers you want to use to create your filter. In the next step, you will be able to refine the filter conditions and specify the actions to be taken on messages that match your criteria." : "Choisissez les en-têtes à utiliser pour créer votre filtre. À l'étape suivante, vous pourrez affiner les conditions de filtrage et spécifier les actions à appliquer aux messages correspondant à vos critères.",
    "Clear" : "Effacer",
    ...
    "Copy to \"Sent\" Folder" : "Copier vers le dossier \"Envoyés\"",
    ...
    "Could not apply tag, configured tag not found" : "Impossible d’appliquer l'étiquette, celle-ci n’existe pas",
    "Could not archive message" : "Impossible d'archiver le message",
    "Could not configure Google integration" : "Impossible de configurer l'intégration Google",
    ...
    "Could not copy message to \"Sent\" folder" : "Impossible de copier le message dans le dossier \"Envoyés\"",
    "Could not copy to \"Sent\" folder" : "Impossible de copier vers le dossier \"Envoyés\"",
    "Could not create event" : "Impossible de créer l'évènement",
    "Could not create snooze mailbox" : "Impossible de créer la boîte de mise en attente des messages",
    ...
    "Could not execute quick action" : "Impossible d’appliquer l’action rapide",
    ...
    "Could not move thread, destination mailbox not found" : "Impossible de déplacer le fil de discussion, le dossier de destination n’existe pas",
    "Could not open folder" : "Impossible d'ouvrir le dossier",
    "Could not open outbox" : "Impossible d'ouvrir la boîte d'envoi",
    "Could not print message" : "Impossible d'imprimer le message",
    ...
    "Could not snooze thread" : "Impossible de mettre le fil en attente",
    "Could not unlink Google integration" : "Impossible de dissocier l'intégration Google",
    "Could not unlink Microsoft integration" : "Impossible de dissocier l'intégration Microsoft",
    ...
    "Create a new mail filter" : "Créer un nouveau filtre d'email",
    "Create a new text block" : "Créer un nouveau bloc de texte",
    "Create alias" : "Créer l'alias",
    "Create event" : "Créer un événement",
    "Create mail filter" : "Créer un filtre d'email",
    ...
    "Do the following actions" : "Exécuter les actions suivantes",
    "domain" : "domaine",
    ...
    "Edit quick action" : "Modifier l’action rapide",
    "Edit tags" : "Modifier les étiquettes",
    "Edit text block" : "Modifier le bloc de texte",
    "email" : "e-mail",
    "Email address" : "Adresse e-mail",
    "Email Address" : "Adresse électronique",
    "Email address already exists" : "L'adresse e-mail existe déjà.",
    "Email address template" : "Modèle d'adresse e-mail",
    "Email Address:" : "Adresse électronique:",
    "Email Administration" : "Gérer les e-mails",
    "Email Provider Accounts" : "Gestion des e-mails",
    "Email service not found. Please contact support" : "Service e-mail introuvable. Veuillez contacter le support",
    "Email username" : "Nom d'utilisateur de messagerie électronique",
    "Email username cannot be empty" : "Le nom d'utilisateur de l'adresse e-mail ne peut pas être vide.",
    "Email username contains invalid characters. Use only letters, numbers, dots, hyphens, and underscores." : "Le nom d'utilisateur de l'adresse e-mail contient des caractères non valides. Utilisez uniquement des lettres, des chiffres, des points, des tirets et des traits de soulignement.",
    ...
    "Enable mail body search" : "Activer la recherche dans le corps de l'e-mail",
    "Enable sieve filter" : "Activer le filtre Sieve",
    "Enable sieve integration" : "Activer l'intégration Sieve",
    "Enable text processing through LLMs" : "Activer le traitement de texte via les LLM",
    ...
    "Enter recipient" : "Saisir le destinataire",
    "Enter sender" : "Saisir l’expéditeur",
    "Enter subject" : "Saisir l’objet",
    ...
    "Failed to add steps to quick action" : "Impossible d'ajouter l’étape à l’action rapide",
    "Failed to create quick action" : "Impossible d’enregistrer l’action rapide",
    "Failed to delete action step" : "Impossible de supprimer l’étape",
    "Failed to delete mailbox" : "Échec de la suppression de la boîte aux lettres",
    "Failed to delete quick action" : "Impossible de supprimer l’action rapide",
    "Failed to delete share with {name}" : "Impossible de supprimer le partage avec {name}",
    "Failed to delete text block" : "Impossible de supprimer le bloc de texte",
    ...
    "Failed to load email providers" : "Échec du chargement des fournisseurs de messagerie",
    "Failed to load mailboxes" : "Échec du chargement des boîtes aux lettres",
    "Failed to load providers" : "Échec du chargement des fournisseurs de messagerie",
    "Failed to save draft" : "Impossible de sauvegarder le brouillon",
    "Failed to save message" : "Impossible de sauvegarder le message",
    "Failed to save text block" : "Impossible de sauvegarder le bloc de texte",
    "Failed to save your participation status" : "Impossible d'enregistrer votre statut de participation",
    "Failed to share text block with {sharee}" : "Impossible de partager le bloc de texte avec {sharee}",
    "Failed to update mailbox" : "Échec de la mise à jour de la boîte aux lettres",
    "Failed to update quick action" : "Impossible de mettre à jour l’action rapide",
    "Failed to update step in quick action" : "Impossible de mettre à jour l’étape de l’action rapide",
    "Favorite" : "Favoris",
    "Favorites" : "Favoris",
    "Filter deleted" : "Filtre supprimé",
    "Filter is active" : "Le filtre est actif",
    "Filter is not active" : "Le filtre est inactif",
    ...
    "Folder search" : "Recherche dans les dossiers",
    "Follow up" : "Suivre",
    "Follow up info" : "Info de suivi",
    "For more details, please click here to open our documentation." : "Pour plus de détails, veuillez consulter notre documentation.",
    ...
    "Group" : "Groupe",
    "Guest" : "Invité",
    "Hang tight while the filters load" : "Patientez pendant le chargement des filtres",
    ...
    "Host" : "Hôte",
    "If all the conditions are met, the actions will be performed" : "Si toutes les conditions sont remplies alors les actions seront réalisées",
    "If any of the conditions are met, the actions will be performed" : "Si l'une des conditions est remplie alors les actions seront réalisées",
    ...
    "IMAP: {user} on {host}:{port} ({ssl} encryption)" : "IMAP : {user} sur {host}:{port} (chiffrement {ssl})",
    ...
    "Internal addresses" : "Adresses internes",
    "Invalid email address or account data provided" : "Adresse e-mail ou données de compte non valides fournies",
    ...
    "List" : "Liste",
    "List of mailboxes. This list is not fully rendered for performance reasons. The mailboxes will be rendered as you navigate through the list." : "Liste des boîtes aux lettres. Cette liste n'est pas entièrement affichée pour des raisons de performances. Les boîtes aux lettres s'afficheront au fur et à mesure que vous naviguerez dans la liste.",
    "Load more" : "Charger davantage",
    "Load more follow ups" : "Charger plus de suivis",
    "Load more important messages" : "Charger plus de messages importants",
    ...
    "Mail configured" : "Courriel configuré",
    "Mail connection performance" : "Performances de connexion de la messagerie",
    "Mail server" : "Serveur de messagerie",
    "Mail server error" : "Erreur du serveur de messagerie",
    "Mail settings" : "Paramètres de Mail",
    "Mail Transport configuration" : "Configuration du Transport de Mail",
    "Mailbox deleted successfully" : "Boîte aux lettres supprimée avec succès",
    "Mailbox deletion" : "Suppression de boîte aux lettres",
    "Mailbox updated successfully" : "Boîte aux lettres mise à jour avec succès",
    "Mails" : "E-mails",
    "Mailto" : "Mailto",
    "Mailvelope" : "Mailvelope",
    "Mailvelope is a browser extension that enables easy OpenPGP encryption and decryption for emails." : "Mailvelope est une extension de navigateur qui permet de chiffrer et déchiffrer facilement les e-mails à l'aide du protocole OpenPGP.",
    ...
    "Manage email accounts for your users" : "Gérez les comptes de messagerie électronique de vos utilisateurs",
    "Manage Emails" : "Gérer les e-mails",
    "Manage quick actions" : "Configurer les actions rapides",
    ...
    "Mark as unimportant" : "Marquer comme non important",
    ...
    "Mentions me" : "Me mentionne",
    "Message" : "Message",
    "Message {id} could not be found" : "Impossible de trouver le message {id}",
    "Message body" : "Corps du message",
    "Message copied to \"Sent\" folder" : "Message copié dans le dossier \"Envoyés\"",
    ...
    "Microsoft integration unlinked" : "Intégration Microsoft dissociée",
    "Microsoft requires you to access your emails via IMAP using OAuth 2.0 authentication. To do this, you need to register an app with Microsoft Entra ID, formerly known as Microsoft Azure Active Directory." : "Microsoft exige que vous accédiez à vos e-mails via IMAP avec l'authentification OAuth 2.0. Pour cela, vous devez enregistrer une application avec Microsoft Entra ID, anciennement Microsoft Azure Active Directory.",
    ...
    "Newest message" : "Dernier message",
    "Next week – {timeLocale}" : "La semaine prochaine – {timeLocale}",
    ...
    "No mailboxes found" : "Aucune boîte aux lettres trouvée",
    ...
    "No name" : "Sans nom",
    "No quick actions yet." : "Il n’existe aucune action rapide",
    "No senders are trusted at the moment." : "Aucun expéditeur n'est marqué comme fiable pour le moment.",
    "No sent folder configured. Please pick one in the account settings." : "Aucun dossier \"Envoyés\" n'est configuré. Veuillez en choisir un dans les paramètres du compte.",
    "No subject" : "Aucun sujet",
    "No text blocks available" : "Aucun bloc de texte disponible",
    "No trash folder configured" : "Aucun dossier \"Corbeille\" configuré",
    "None" : "Aucun",
    ...
    "Open search modal" : "Ouvrir la fenêtre de recherche",
    ...
    "Please enter a valid email user name" : "Veuillez saisir un nom d'utilisateur e-mail valide",
    ...
    "Please select languages to translate to and from" : "Veuillez sélectionner les langues à ou vers lesquelles traduire",
    "Please wait 10 minutes before repairing again" : "Veuillez attendre 10 minutes avant de réparer à nouveau",
    "Please wait for the message to load" : "Veuillez patienter pendant le chargement du message",
    "Port" : "Port",
    ...
    "Provisioning Configurations" : "Configurations d'approvisionnement",
    ...
    "Quick action created" : "Action rapide enregistrée",
    "Quick action deleted" : "Action rapide supprimée",
    "Quick action executed" : "Action rapide appliquée",
    "Quick action name" : "Nom de l’action rapide",
    "Quick action updated" : "Action rapide mise à jour",
    ...
    "Scroll to load more rows" : "Faites défiler pour charger plus de lignes",
    "Search" : "Rechercher",
    "Search body" : "Rechercher dans le corps",
    "Search for users or groups" : "Rechercher des utilisateurs ou des groupes",
    ...
    "Select email provider" : "Sélectionnez votre fournisseur de messagerie électronique",
    ...
    "Mail server marked this message as phishing attempt" : "Le serveur de messagerie a marqué ce message comme une tentative d'hameçonnage",
    ...
    "Server error. Please try again later" : "Erreur du serveur. Veuillez réessayer plus tard",
    "This email address already exists" : "Cette adresse e-mail existe déjà",
    "IMAP server is not reachable" : "Le serveur IMAP n'est pas joignable",
    ...
    "IMAP server denied authentication" : "Le serveur IMAP a refusé l'authentification",
    "SMTP server denied authentication" : "Le serveur SMTP a refusé l'authentification",
    "IMAP authentication error" : "Erreur d'authentification IMAP",
    "SMTP authentication error" : "Erreur d'authentification SMTP",
    "IMAP connection failed" : "Échec de la connexion IMAP",
    "SMTP connection failed" : "Échec de la connexion SMTP",
    "Authorization pop-up closed" : "Fenêtre d'autorisation fermée",
    "Configuration discovery temporarily not available. Please try again later." : "Découverte de configuration temporairement indisponible. Merci de réessayer plus tard.",
    "There was an error while setting up your account" : "Une erreur est survenue lors de la configuration de votre compte",
    "Auto" : "Auto",
    "Name" : "Nom",
    "Mail address" : "Adresse e-mail",
    "name@example.org" : "nom@exemple.org",
    "Please enter an email of the format name@example.com" : "Veuillez saisir une adresse e-mail au format nom@exemple.com",
    "Password" : "Mot de passe",
    "Enable mark as important classification" : "Activer la classification des mails importants",
    "Manual" : "Manuel",
    "IMAP Settings" : "Paramètres IMAP",
    "IMAP Host" : "Hôte IMAP",
    "IMAP Security" : "Sécurité IMAP",
    ...
    "Classification settings" : "Paramètres de classification",
    "Filters" : "Filtres",
    "Quick actions" : "Actions rapides",
    "Sieve script editor" : "Editeur de script Sieve",
    "Mail server" : "Serveur de messagerie",
    "Sieve server" : "Serveur Sieve",
    "Folder search" : "Recherche dans les dossiers",
    ...
    "Activate" : "Activer",
    "Make mails available to Context Chat" : "Rendre les emails disponibles pour l'écriture selon un contexte",
    "Remind about messages that require a reply but received none" : "Me faire un rappel pour les messages qui nécessite une réponse et qui n'en ont reçue aucune",
    ...
    "Sort favorites up" : "Afficher les favoris d'abord",
    "When on, favorite messages will be sorted to the top of folders" : "Si activé, les messages favoris seront affichés en haut des dossiers",
    "Layout" : "Mise en page",
    ...
    "Allow the app to collect and process data locally to adapt to your preferences" : "Autoriser l'application à collecter et traiter les données localement pour s'adapter à vos préférences",
    "Always show images from" : "Toujours afficher les images depuis",
    "Security" : "Sécurité",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Gérer vos adresses internes et vos domaines pour que vos contacts reconnus restent non marqués",
    "S/MIME" : "S/MIME",
    "Manage certificates" : "Gérer les certificats",
    "Mailvelope" : "Mailvelope",
    "Mailvelope is enabled for the current domain." : "Mailvelope est activé pour le domaine actuel.",
    ...
    "Content of the text block" : "Contenu du bloc de texte",
    "Ok" : "Ok",
    "Automatically create tentative appointments in calendar" : "Créer des rendez-vous provisoires automatiquement dans le calendrier",
    "No certificate" : "Aucun certificat",
    "Certificate updated" : "Certificat mis à jour",
    "Could not update certificate" : "Impossible de mettre à jour le certificat",
    "{commonName} - Valid until {expiryDate}" : "{commonName} - Valide jusqu'au {expiryDate}",
    ...
    "Could not snooze thread" : "Impossible de mettre le fil en attente",
    "Thread was unsnoozed" : "La mise en attente du fil a été annulée",
    "Could not unsnooze thread" : "Impossible d'annuler la mise en attente du fil",
    "This summary was AI generated" : "Ce résumé a été généré par IA",
    "Encrypted message" : "Message chiffré",
    ...
    "Manage quick actions" : "Configurer les actions rapides",
    "Load more" : "Charger davantage",
    "_Mark {number} read_::_Mark {number} read_" : ["Marquer {number} comme lu","Marquer {number} comme lus","Marquer {number} comme lus"],
    "_Mark {number} unread_::_Mark {number} unread_" : ["Marquer {number} comme non lu","Marquer {number} comme non lus","Marquer {number} comme non lus"],
    "_Mark {number} as important_::_Mark {number} as important_" : ["Marquer {number} comme important","Marquer {number} comme importants","Marquer {number} comme importants"],
    "_Mark {number} as unimportant_::_Mark {number} as unimportant_" : ["Marquer {number} comme non important","Marquer {number} comme non importants","Marquer {number} comme non importants"],
    "_Unfavorite {number}_::_Unfavorite {number}_" : ["Retirer des favoris","Retirer des favoris {number}","Retirer des favoris {number}"],
    "_Favorite {number}_::_Favorite {number}_" : ["Ajouter {number} aux favoris","Ajouter {number} aux favoris ","Ajouter {number} aux favoris "],
    "_Unselect {number}_::_Unselect {number}_" : ["Désélectionner {number} message","Désélectionner {number} messages","Désélectionner {number}"],
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Marquer {number} comme indésirable","Marquer {number} comme indésirables","Marquer {number} comme indésirables"],
    "_Mark {number} as not spam_::_Mark {number} as not spam_" : ["Marquer {number} comme légitime","Marquer {number} comme légitimes","Marquer {number} comme légitimes"],
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Modifier les étiquettes pour {number}","Modifier les étiquettes pour {number}","Modifier les étiquettes pour {number}"],
    "_Move {number} thread_::_Move {number} threads_" : ["Déplacer {number} conversation","Déplacer {number} conversations","Déplacer {number} conversations"],
    "_Forward {number} as attachment_::_Forward {number} as attachment_" : ["Transférer {number} en pièce jointe","Transférer {number} en pièce jointe","Transférer {number} en pièce jointe"],
    "Mark as unread" : "Marquer comme non lu",
    "Mark as read" : "Marquer comme lu",
    "Mark as unimportant" : "Marquer comme non important",
    "Mark as important" : "Marquer comme important",
    ...
    "All day" : "Toute la journée",
    "Attendees" : "Participants",
    "You can only invite attendees if your account has an email address set" : "Vous ne pouvez inviter des participants que si votre compte dispose d'une adresse e-mail.",
    "Select calendar" : "Choisir le calendrier",
    "Description" : "Description",
    "Create" : "Créer",
    ...
    "You have been invited to an event" : "Vous avez été invité·e à un événement",
    ...
    "Add internal email or domain" : "Ajouter un e-mail interne ou un domaine",
    "Itinerary for {type} is not supported yet" : "L'itinéraire pour {type} n'est pas encore pris en charge",
    "To archive a message please configure an archive folder in account settings" : "Pour archiver un message, veuillez configurer un dossier d'archivage dans les paramètres du compte",
    ...
    "Moving thread" : "Déplacement du fil de discussion en cours",
    "Moving message" : "Déplacement du message",
    "This account cannot connect" : "Ce compte ne peut pas se connecter",
    "Connection failed. Please verify your information and try again" : "Connexion échouée. Merci de vérifier vos identifiants et réessayer",
    "Used quota: {quota}% ({limit})" : "Quota utilisé : {quota}% ({limit})",
    "Used quota: {quota}%" : "Quota utilisé : {quota}%",
    ...
    "Move up" : "Monter",
    "Move down" : "Descendre",
    "Show all subscribed folders" : "Afficher tous les dossiers suivis",
    ...
    "Outbox" : "Boîte d'envoi",
    "Translate this message to {language}" : "Traduire ce message en {language}",
    "New message" : "Nouveau message",
    "Edit message" : "Modifier le message",
    "Draft" : "Brouillon",
    "Reply" : "Répondre",
    ...
    "attachment" : "Pièce jointe",
    "attached" : "joint",
    "No \"sent\" folder configured. Please pick one in the account settings." : "Pas de dossier \"Envoyés\" configuré. Merci d'en choisir un dans les paramètres du compte.",
    ...
    "Start writing a message by clicking below or select an existing message to display its contents" : "Commencez à écrire un message en cliquant ci-dessous ou sélectionnez un message existant pour afficher son contenu",
    "Autoresponder off" : "Répondeur automatique désactivé",
    "Autoresponder on" : "Répondeur automatique activé",
    "Autoresponder follows system settings" : "Le réponse automatique suit les paramètres système",
    "The autoresponder follows your personal absence period settings." : "Le réponse automatique suit vos paramètres de période d'absence.",
    "Edit absence settings" : "Modifier les paramètres d'absence",
    "First day" : "Premier jour",
    "Last day (optional)" : "Dernier jour (optionnel)",
    "${subject} will be replaced with the subject of the message you are responding to" : "${subject} sera remplacé par l'objet du message auquel vous répondez",
    ...
    "Go to latest message" : "Aller au dernier message",
    "Newest message" : "Dernier message",
    "This summary is AI generated and may contain mistakes." : "Ce résumé est généré par IA et peut contenir des erreurs.",
    "Please select languages to translate to and from" : "Veuillez sélectionner les langues à ou vers lesquelles traduire",
    ...
    "Source language to translate from" : "Langue source à traduire",
    "Translate from" : "Traduire depuis",
    "Target language to translate into" : "Langue cible vers laquelle traduire",
    ...
    "Train" : "Train",
    "Mark message as" : "Marquer le message comme",
    "Add flag" : "Marquer",
    "Move into folder" : "Déplacer vers un dossier ",
    "Stop" : "Arrêter",
    "Delete action" : "Supprimer l'action",
    ...
    "Saved config for \"{domain}\"" : "Configuration sauvegardée pour \"{domain}\"",
    "Could not save provisioning setting" : "Impossible de sauvegarder le paramètre de provisionnement",
    "_Successfully provisioned {count} account._::_Successfully provisioned {count} accounts._" : ["Le provisionnement d'{count} compte a été effectué avec succès.","Le provisionnement des {count} comptes a été effectué avec succès.","Le provisionnement des {count} comptes a été effectué avec succès."],
    ...
    "These settings can be used in conjunction with each other." : "Ces paramètres peuvent être utilisés conjointement.",
    "If you only want to provision one domain for all users, use the wildcard (*)." : "Si vous ne voulez provisionner qu'un seul domaine pour tous les utilisateurs, utilisez le caractère wildcard (*).",
    "This setting only makes most sense if you use the same user back-end for your Nextcloud and mail server of your organization." : "Ce paramètre n'a de sens que si vous utilisez le même service d'utilisateurs pour votre Nextcloud et le serveur de messagerie de votre organisation.",
    "Provisioning Configurations" : "Configurations d'approvisionnement",
    "Add new config" : "Ajouter une nouvelle configuration",
    "Provision all accounts" : "Provisionner tous les comptes",
    "Allow additional mail accounts" : "Autoriser des comptes de messagerie supplémentaires",
    ...
    "Share deleted for {name}" : "Partage supprimé pour {name}",
    "Shared" : "Partagé",
    "Shared with me" : "Partagé avec moi",
    "Shares" : "Partages",
    "Should a new matching configuration be found after the user was already provisioned with another configuration, the new configuration will take precedence and the user will be reprovisioned with the configuration." : "Si une nouvelle configuration correspondante est trouvée alors que l'utilisateur a déjà été provisionné avec une autre configuration, la nouvelle configuration sera prioritaire et l'utilisateur sera reprovisionné avec cette configuration.",
    ...
    "Submit" : "Envoyer",
    "No text blocks available" : "Aucun bloc de texte disponible",
    "Text block deleted" : "Bloc de texte supprimé",
    "Failed to delete text block" : "Impossible de supprimer le bloc de texte",
    "Text block shared with {sharee}" : "Bloc de texte partagé avec {sharee}",
    "Failed to share text block with {sharee}" : "Impossible de partager le bloc de texte avec {sharee}",
    "Share deleted for {name}" : "Partage supprimé pour {name}",
    "Failed to delete share with {name}" : "Impossible de supprimer le partage avec {name}",
    "Guest" : "Invité",
    ...
    "Search in the body of messages in priority Inbox" : "Recherche dans le corps des messages de la boîte de réception prioritaire",
    "Put my text to the bottom of a reply instead of on top of it." : "Mettre mon texte en bas d'une réponse au lieu de le mettre au-dessus.",
    "Use internal addresses" : "Utiliser les adresses internes",
    "Accounts" : "Comptes",
    "Newest" : "Plus récent",
    "Oldest" : "Plus ancien",
    "Reply text position" : "Position de la réponse",
    ...
    "Sieve server" : "Serveur Sieve",
    "Sieve User" : "Utilisateur Sieve",
    "Sieve: {user} on {host}:{port} ({ssl} encryption)" : "Sieve : {user} sur {host}:{port} (chiffrement {ssl})",
    ...
    "SMTP User" : "Utilisateur SMTP",
    "SMTP username or password is wrong" : "Le nom d’utilisateur ou le mot de passe SMTP est incorrect",
    "SMTP: {user} on {host}:{port} ({ssl} encryption)" : "SMTP : {user} sur {host}:{port} (chiffrement {ssl})",
    "Snooze" : "Mettre en attente",
    ...
    "STARTTLS" : "STARTTLS",
    "Status" : "Statut",
    "Step 1: Install Mailvelope browser extension" : "Étape 1 : Installer l'extension de navigateur Mailvelope",
    "Step 2: Enable Mailvelope for the current domain" : "Étape 2 : Activer Mailvelope pour le domaine actuel",
    "Stop" : "Arrêter",
    "Stop ends all processing" : "Arrêter l’exécution",
    "Subject" : "Sujet",
    "Subject …" : "Sujet...",
    ...
    "Subscribed" : "Abonné",
    "Successfully deleted and deprovisioned accounts for \"{domain}\"" : "Les comptes de \"{domain}\" ont été supprimés et déprovisionnés avec succès",
    "Successfully deleted anti spam reporting email" : "E-mail de signalement anti-spam supprimé avec succès",
    "Successfully set up anti spam email addresses" : "E-mail de signalement anti-spam enregistré avec succès",
    "Successfully updated config for \"{domain}\"" : "La mise à jour de la configuration de \"{domain}\" a été effectuée avec succès",
    "Summarizing thread failed." : "Le résumé du fil a échoué.",
    "Sync in background" : "Synchronisation en arrière-plan",
    "Tag" : "Étiquette",
    ...
    "The tag will be deleted from all messages." : "L'étiquette sera supprimée de tous les messages.",
    "The thread doesn't exist or has been deleted" : "Le fil de discussion n'existe pas ou a été supprimé",
    "There are no mailboxes to display." : "Il n'y a aucune boîte aux lettres à afficher.",
    "There can only be one configuration per domain and only one wildcard domain configuration." : "Il ne peut y avoir qu'une seule configuration par domaine et qu'une seule configuration de domaine wildcard.",
    "There is already a message in progress. All unsaved changes will be lost if you continue!" : "Il y a déjà un message en cours. Tout changement non sauvegardé sera perdu si vous continuez !",
    "There was a problem loading {tag}{name}{endtag}" : "Il y a eu un problème de chargement {tag}{name}{endtag}",
    "There was an error when provisioning accounts." : "Il y avait une erreur lors du provisionnement des comptes.",
    ...
    "These settings are used to pre-configure the user interface preferences they can be overridden by the user in the mail settings" : "Ces paramètres sont utilisés pour préconfigurer les préférences de l'interface utilisateur ; ils peuvent être modifiés par l'utilisateur dans les paramètres de Mail",
    "These settings can be used in conjunction with each other." : "Ces paramètres peuvent être utilisés conjointement.",
    "This action cannot be undone. All emails and settings for this account will be permanently deleted." : "Cette action ne peut pas être annulée. Tous les e-mails et paramètres de ce compte seront définitivement supprimés.",
    "This application includes CKEditor, an open-source editor. Copyright © CKEditor contributors. Licensed under GPLv2." : "Cette application utilise CKEditor, un éditeur de texte open-source. Copyright © CKEditor contributors. Licensed under GPLv2.",
    "This email address already exists" : "Cette adresse e-mail existe déjà",
    "This email might be a phishing attempt" : "Cet e-mail pourrait être une tentative de phishing",
    "This event was cancelled" : "Cet événement a été annulé",
    ...
    "Title of the text block" : "Titre du bloc de texte",
    "To" : "À",
    "To access your mailbox via IMAP, you can generate an app-specific password. This password allows IMAP clients to connect to your account." : "Pour accéder à votre boîte mail via IMAP, vous pouvez générer un mot de passe spécifique à l'application. Ce mot de passe permet aux clients IMAP de se connecter à votre compte.",
    "To add a mail account, please contact your administrator." : "Pour ajouter un compte de messagerie, veuillez contacter votre administrateur.",
    "To archive a message please configure an archive folder in account settings" : "Pour archiver un message, veuillez configurer un dossier d'archivage dans les paramètres du compte",
    "To Do" : "À faire",
    "Today" : "Aujourd’hui",
    ...
    "Tomorrow morning" : "Demain matin",
    "Top" : "Haut",
    "Total rows summary" : "Résumé du nombre total de lignes",
    "Train" : "Train",
    "Train from {depStation} to {arrStation}" : "Train de {depStation} pour {arrStation}",
    "Translate" : "Traduire",
    "Translate from" : "Traduire depuis",
