OC.L10N.register(
    ...
    "_{count} mailbox_::_{count} mailboxes_" : ["{count} buzón","{count} buzones","{count} buzones"],
    "_{count} mailbox …_::_{count} mailboxes …_" : ["{count} buzón …","{count} buzones …","{count} buzones …"],
    "{from}\n{subject}" : "{from}\n{subject}",
    ...
    "Email Address:" : "Dirección de correo electrónico:",
    "Email Administration" : "Gestionar el correo electrónico",
    "Email Provider Accounts" : "Gestión del correo electrónico",
    "Email service not found. Please contact support" : "Servicio de correo no encontrado. Por favor, contacte al soporte",
    "Email username" : "Nombre de usuario del correo electrónico",
    "Email username cannot be empty" : "El nombre de usuario del correo electrónico no puede estar vacío.",
    "Email username contains invalid characters. Use only letters, numbers, dots, hyphens, and underscores." : "El nombre de usuario del correo electrónico contiene caracteres no válidos. Utilice solo letras, números, puntos, guiones y guiones bajos.",
    ...
    "Failed to update mailbox" : "No se pudo actualizar el buzón.",
    ...
    "List" : "Lista",
    "List of mailboxes. This list is not fully rendered for performance reasons. The mailboxes will be rendered as you navigate through the list." : "Lista de buzones. Esta lista no se muestra completamente por motivos de rendimiento. Los buzones se mostrarán a medida que navegue por la lista.",
    ...
    "Mailbox updated successfully" : "Buzón actualizado correctamente",
    "Mails" : "Mails",
