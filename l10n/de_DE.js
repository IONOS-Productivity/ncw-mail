OC.L10N.register(
    ...
    "Activate" : "Aktivieren",
    "Make mails available to Context Chat" : "E-Mails für Context Chat verfügbar machen",
    "Remind about messages that require a reply but received none" : "Erinnerung an Nachrichten, die eine Antwort erfordern, aber keine erhalten haben",
    ...
    "Security" : "Sicherheit",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Ihre internen Adressen und Domänen verwalten, um sicherzustellen, dass erkannte Kontakte nicht markiert bleiben",
    "S/MIME" : "S/MIME",
    ...
    "Choose target folder" : "Zielordner auswählen",
    "No more submailboxes in here" : "Keine Unter-Postfächer vorhanden",
    "Messages will automatically be marked as important using AI. The system learns from which messages you interact with or mark as important. In the beginning you might have to manually change the importance to teach it, but it will improve over time" : "Nachrichten werden mithilfe von KI automatisch als wichtig markiert. Das System erfährt, mit welchen Nachrichten Sie interagieren oder welche Sie als wichtig markieren. Zu Beginn muss u. U. manuell die Wichtigkeit geändert werden, um dies anzulernen. Dies wird sich mit der Zeit verbessern",
    ...
    "AI identifies messages sent by you that likely require a reply but did not receive one after a couple of days and shows them here" : "KI erkennt von Ihnen gesendete Nachrichten, die wahrscheinlich eine Antwort erfordern, aber nach ein paar Tagen keine erhalten haben, und zeigt sie hier an",
    "Favorites" : "Favoriten",
    ...
    "Connection failed. Please verify your information and try again" : "Verbindung fehlgeschlagen. Bitte Ihre Daten überprüfen und es erneut versuchen",
    ...
    "Attachments were not copied. Please add them manually." : "Anhänge konnten nicht kopiert werden. Bitte manuell hinzufügen.",
    "Could not create snooze mailbox" : "Das Zurückstellen-Postfach konnte nicht erstellt werden",
    "Sorry, the message could not be loaded. The draft may no longer exist. Please refresh the page and try again." : "Leider konnte die Nachricht nicht geladen werden. Der Entwurf existiert möglicherweise nicht mehr. Bitte die Seite aktualisieren und es erneut versuchen.",
    "Sending message…" : "Sende Nachricht…",
    "Message sent" : "Nachricht versandt",
    "Could not send message" : "Nachricht kann nicht versandt werden",
    "Message copied to \"Sent\" folder" : "Nachricht in den \"Gesendet\"-Ordner kopiert",
