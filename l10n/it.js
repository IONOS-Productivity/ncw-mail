OC.L10N.register(
    ...
    "_{count} mailbox_::_{count} mailboxes_" : ["{count} casella di posta","{count} caselle di posta","{count} caselle di posta"],
    "_{count} mailbox …_::_{count} mailboxes …_" : ["{count} casella di posta …","{count} caselle di posta …","{count} caselle di posta …"],
    "{from}\n{subject}" : "{from}\n{subject}",
    ...
    "Allow aliases" : "Consenti gli alias",
    ...
    "Allow users to create mail aliases" : "Consentire agli utenti di creare alias di posta elettronica",
    ...
    "Are you sure you want to delete the mailbox for {email}?" : "Sei sicuro di voler eliminare la casella di posta elettronica {email}?",
    "attached" : "allegato",
    "attachment" : "allegato",
    ...
    "Creating aliases has been disabled by the administrator." : "La creazione di alias è stata disabilitata dall'amministratore.",
    ...
    "Delete mailbox" : "Elimina casella postale",
    ...
    "Display name" : "Nome visualizzato",
    "Display name cannot be empty" : "Il nome visualizzato non può essere vuoto",
    "domain" : "dominio",
    ...
    "Email address already exists" : "L'indirizzo e-mail esiste già",
    "Email address template" : "Modello d'indirizzo email",
    "Email Address:" : "Indirizzo e-mail:",
    "Email Administration" : "Gestisci email",
    "Email Provider Accounts" : "Gestione delle e-mail",
    "Email username" : "Nome utente e-mail",
    "Email username cannot be empty" : "Il nome utente dell'indirizzo e-mail non può essere vuoto",
    "Email username contains invalid characters. Use only letters, numbers, dots, hyphens, and underscores." : "Il nome utente dell'indirizzo e-mail contiene caratteri non validi. Utilizza solo lettere, numeri, punti, trattini e trattini bassi.",
    ...
    "Failed to delete mailbox" : "Impossibile eliminare la casella di posta",
    ...
    "Failed to load email providers" : "Impossibile caricare i provider di posta elettronica",
    "Failed to load mailboxes" : "Impossibile caricare le caselle di posta",
    "Failed to load providers" : "Impossibile caricare i provider di posta elettronica",
    ...
    "Failed to update mailbox" : "Impossibile aggiornare la casella di posta",
    "Favorite" : "Preferito",
    "Favorites" : "Preferiti",
    "Filters" : "Filtri",
    ...
    "List" : "Elenco",
    "List of mailboxes. This list is not fully rendered for performance reasons. The mailboxes will be rendered as you navigate through the list." : "Elenco delle caselle di posta. Questo elenco non viene visualizzato completamente per motivi di prestazioni. Le caselle di posta verranno visualizzate man mano che si naviga nell'elenco.",
    ...
    "Mail configured" : "Posta elettronica configurata",
    "Mail server" : "Server di posta",
    "Mail settings" : "Impostazioni Posta",
    "Mailbox deleted successfully" : "Casella di posta eliminata con successo",
    "Mailbox deletion" : "Eliminazione della casella postale",
    "Mailbox updated successfully" : "Casella di posta aggiornata con successo",
    "Mails" : "Messaggi di posta",
    "Mailvelope" : "Mailvelope",
    "Manage certificates" : "Gestisci certificati",
    "Manage email accounts for your users" : "Gestisci gli account e-mail dei tuoi utenti",
    "Manage Emails" : "Gestisci le e-mail",
    ...
    "No mailboxes found" : "Nessuna casella postale trovata",
    ...
    "Scroll to load more rows" : "Scorri per caricare altre righe",
    "Search" : "Cerca",
    ...
    "Select email provider" : "Seleziona il provider di posta elettronica",
    ...
    "There are no mailboxes to display." : "Non ci sono caselle di posta da visualizzare.",
    ...
    "This action cannot be undone. All emails and settings for this account will be permanently deleted." : "Questa azione non può essere annullata. Tutte le e-mail e le impostazioni relative a questo account verranno eliminate definitivamente.",
    ...
    "Total rows summary" : "Riepilogo totale righe",
    "Train" : "Treno",
